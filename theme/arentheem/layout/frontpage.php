	...
	<div id="page">
		...
		<div id="wrapper" class="clearfix">
	        ...
	        <?php
        		...
        		?>
        		<a href="http://www.arentheem.nl" title="Arentheem">
        		<img src="<?php echo $OUTPUT->pix_url('arentheem_logo','theme')?>" alt="Arentheem logo" />
        		</a>
        		<?php
